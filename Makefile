.PHONY: demo demo-settlement demo-regtech demo-nl demo-smart-contract demo-medical demo-all demo-ci report setup
...
demo-ci:
	@status=0; \
	for scenario in ownership_transfer rtgs_settlement regtech_compliance nl_to_verified smart_contract_audit medical_device; do \
